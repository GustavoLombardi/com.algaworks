...
insert into cliente (id, nome) values (2, 'Gustavo');
insert into cliente (id, nome) values (1, 'Manuel');

insert into pedido (id, cliente_id, data_pedido,total, status) values(1,2, sysdate(), 100.0, 'AGUARDANDO');
